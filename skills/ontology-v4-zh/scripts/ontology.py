...
def main():
    parser = argparse.ArgumentParser(description="本体图谱操作")
    ...
    query_p.add_argument("--where", "-w", default="{}", help="筛选条件 JSON")
    ...
    related_p.add_argument("--rel", "-r", help="关系类型筛选")
    ...
    schema_p.add_argument("--data", "-d", help="Schema 片段 JSON")
